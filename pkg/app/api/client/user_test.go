...
func TestUser(t *testing_.T) {
	...
	t.Run("UpdateAPISecretAsRoot", func(t *testing_.T) {
	...
	t.Run("UpdateAPISecretAsOrgOwner", func(t *testing_.T) {
	...
	t.Run("UpdateAPISecretAsRegularUser", func(t *testing_.T) {
	...
	t.Run("UpdateDisplayNameAsRoot", func(t *testing_.T) {
	...
	t.Run("UpdateDisplayNameAsOrgOwner", func(t *testing_.T) {
	...
	t.Run("UpdateDisplayNameAsRegularUser", func(t *testing_.T) {
	...
	t.Run("UpdatePasswordAsRoot", func(t *testing_.T) {
	...
	t.Run("UpdatePasswordAsOrgOwner", func(t *testing_.T) {
	...
	t.Run("UpdatePasswordAsRegularUser", func(t *testing_.T) {
	...
	t.Run("UpdateStatusAsRoot", func(t *testing_.T) {
	...
	t.Run("UpdateStatusAsOrgOwner", func(t *testing_.T) {
	...
	t.Run("UpdateStatusAsRegularUser", func(t *testing_.T) {
